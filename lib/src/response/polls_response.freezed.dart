...
mixin _$Choices {
  ...
  int? get channelPointsVotes => throw _privateConstructorUsedError;
  int? get bitsVotes => throw _privateConstructorUsedError;
...
class _$ChoicesCopyWithImpl<$Res, $Val extends Choices>
  ...
  $Res call({
    ...
    Object? channelPointsVotes = freezed,
    Object? bitsVotes = freezed,
  }) {
    return _then(_value.copyWith(
      id: freezed == id
          ? _value.id
      ...
      votes: freezed == votes
          ...
          : votes // ignore: cast_nullable_to_non_nullable
              as int?,
      channelPointsVotes: freezed == channelPointsVotes
          ? _value.channelPointsVotes
          : channelPointsVotes // ignore: cast_nullable_to_non_nullable
              as int?,
      bitsVotes: freezed == bitsVotes
          ? _value.bitsVotes
          : bitsVotes // ignore: cast_nullable_to_non_nullable
              as int?,
    ) as $Val);
  }
}
...
class _$_Choices implements _Choices {
  ...
  final int? votes;
  @override
  final int? channelPointsVotes;
  @override
  final int? bitsVotes;

  @override
  String toString() {
    return 'Choices(id: $id, title: $title, votes: $votes, channelPointsVotes: $channelPointsVotes, bitsVotes: $bitsVotes)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.channelPointsVotes, channelPointsVotes) ||
                other.channelPointsVotes == channelPointsVotes) &&
            (identical(other.bitsVotes, bitsVotes) ||
                other.bitsVotes == bitsVotes));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, votes, channelPointsVotes, bitsVotes);
...
abstract class _Choices implements Choices {
  const factory _Choices(
      ...
      final int? votes,
      final int? channelPointsVotes,
      final int? bitsVotes}) = _$_Choices;

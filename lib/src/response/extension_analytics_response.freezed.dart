...
mixin _$ExtensionAnalyticsResponse {
  List<ExtensionAnalyticsResponseData>? get data =>
...
abstract class $ExtensionAnalyticsResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<ExtensionAnalyticsResponseData>? data, Pagination? pagination});
    ...
    return _then(_value.copyWith(
      data: freezed == data
          ...
          : data // ignore: cast_nullable_to_non_nullable
              as List<ExtensionAnalyticsResponseData>?,
...
abstract class _ExtensionAnalyticsResponse
  ...
  const factory _ExtensionAnalyticsResponse(
      ...
      final Pagination? pagination}) = _$_ExtensionAnalyticsResponse;
